      ...
      <div className="lg:ml-64 min-h-screen bg-[#0a0a0f]">
        ...
        <main className="pt-24 pb-32 px-4">
          <div className="max-w-full mx-auto">
            <div className="bg-black border-b border-gray-800 sticky top-20 z-30 py-3 px-6 flex flex-wrap items-center justify-between text-sm">
              ...
              <div className="flex gap-3 mt-2 lg:mt-0">
                <button className="px-4 py-2 bg-purple-600 rounded">Trending</button>
            ...
            <div className="bg-[#111] rounded-xl overflow-hidden border border-gray-800 mt-4">
        ...
        <footer className="bg-[#0a0a0f] border-t border-gray-800">
          <div className="max-w-7xl mx-auto px-6 py-12 text-center">
            <p className="text-gray-400 text-sm leading-relaxed max-w-5xl mx-auto mb-10">
              All content available on our website... (same DEXTools disclaimer)
            </p>
